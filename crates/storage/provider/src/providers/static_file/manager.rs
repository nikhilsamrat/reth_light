...
impl<N: NodePrimitives<SignedTx: ValueInner, Receipt: ValueInner, BlockHeader: ValueInner>> TransactionsProviderExt
    for StaticFileProvider<N>
{
...
impl<N: NodePrimitives<SignedTx: ValueInner, Receipt: ValueInner, BlockHeader: ValueInner>> BlockReader
    for StaticFileProvider<N>
{
    type Block = N::Block;
